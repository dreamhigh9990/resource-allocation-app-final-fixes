...
import compensationExporterFields from 'src/app/compensation/list/compensation-exporter-fields';
...
export class CompensationListService {
  ...
  async doExport() {
    try {
      ...
      const response = await CompensationApi.list(
        filter,
        this.orderBy,
        null,
        null,
