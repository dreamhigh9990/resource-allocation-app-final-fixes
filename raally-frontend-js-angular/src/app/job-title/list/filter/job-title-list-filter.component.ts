...
@Component({
  selector: 'app-job-title-list-filter',
  templateUrl: './job-title-list-filter.component.html',
})
export class JobTitleListFilterComponent implements OnInit {
  form: FormGroup;
  schema: FilterSchema;
  expanded: boolean = false;

  constructor(
    private service: JobTitleListService,
