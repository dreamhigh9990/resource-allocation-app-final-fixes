...
The Backend app uses SQLite, you can add/remove any data that you want, but please don´t change the structure of the database.
...
The application will be available at http://localhost:4200 and by default you should see a welcome message there.
